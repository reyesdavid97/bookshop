...
class Language(models.Model):
    ...
    name = models.CharField(max_length=50, help_text="Enter the book's language (e.g. English, French, Japanese, etc.)")
...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13, help_text='13 character ISBN code')
    ...
    def display_rating(self):
        # Create a string for the Rating.
